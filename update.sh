...
terrad tx wasm store artifacts/terra_peep721.wasm --chain-id columbus-5 --from terrapeep --fees 391868uusd --gas auto -y -b sync --gas-adjustment 1.2
...
terrad tx wasm instantiate 903 ${json} --chain-id columbus-5 --gas auto --from terrapeep --fees  54627uusd --admin terra1d85ncnvn822u5lul9kf8430dd3chyjd3ka2f98 --gas-adjustment 1.2
